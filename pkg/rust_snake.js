import { random } from './snippets/rust-snake-5c39ea7207f4ed85/index/utils/random.js';
...
export class World {
    ...
    */
    static new(width, snake_index) {
        const ret = wasm.world_new(width, snake_index);
    ...
    */
    change_direction(direction) {
        wasm.world_change_direction(this.__wbg_ptr, direction);
    }
    /**
    * @returns {number}
    */
    ...
    */
    snake_index() {
        const ret = wasm.world_snake_index(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    */
    ...
    */
    snake_len() {
        const ret = wasm.world_snake_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_random_e9b3ae9403b203c1 = function(arg0) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_snake_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
